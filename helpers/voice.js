...
async function handleMessage(ctx) {
    try {
        ...
        // Get voice message
        const voice = message.voice || message.document || message.audio || message.video_note
 ...
 */
async function updateMessagewithTranscription(ctx, msg, text) {
    // Create options
    const options = {}
 ...
 */
async function sendMessageWithTranscription(ctx, text, chat) {
    // Get message
    const message = ctx.message || ctx.update.channel_post
    // Create options
    const options = {
